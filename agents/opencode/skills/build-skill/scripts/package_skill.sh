...
echo ""
echo "To install, extract to one of the supported locations:"
echo "  Pi (global):        ~/.pi/agent/skills/"
echo "  OpenCode (project): .opencode/skills/"
echo "  OpenCode (global):  ~/.config/opencode/skills/"
echo "  Claude (global):    ~/.claude/skills/"
echo "  Codex (global):     ~/.codex/skills/"
