---
name: build-skill
description: Create effective skills for coding agents. Load FIRST before writing any SKILL.md. Provides required format, naming conventions, progressive disclosure patterns, and validation. Use when building, reviewing, or debugging skills.
---
...
Place in a supported skills directory for your agent runtime (see Skill Locations below).
...
Currently supported coding agent paths:

| Agent | Scope | Path |
|-------|-------|------|
| Pi | Global | `~/.pi/agent/skills/<name>/` |
...
For OpenCode, project-local path typically overrides global when names collide.
